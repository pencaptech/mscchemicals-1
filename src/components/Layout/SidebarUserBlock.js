                    ...
                    <div className="item user-block">
                       ...
                       <div className="user-block-picture">
                          <div className="user-block-status">
                             <img className="img-thumbnail rounded-circle" src="img/user.jpg" alt="Avatar" width="60" height="60" />
...
const mapStateToProps = state => ({ showUserBlock: state.settings.showUserBlock,user:state.login.userObj })
