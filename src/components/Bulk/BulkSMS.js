...
import CharCountTextarea from '../Common/CharCountTextarea';
                                ...
                                <form className="form-horizontal" onSubmit={this.onSubmit}>
                                        ...
                                        <FormGroup row>
                                            ...
                                            <div className="col-md-10">
                                                ...
                                                <label className="c-radio">
                                                    ...
                                                    <span className="fa fa-circle"></span>Contacts</label>
                                            </div>
                                        </FormGroup>
                                    </fieldset>
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <Col md={10}>
                                                <textarea rows="5" className="form-control" maxLength="1000"
                                                    onChange={this.updateContacts} placeholder="phone numbers seperated by commas(,)..." required></textarea>
                                            </Col>
                                        </div>
                                    </fieldset>}
                                    <fieldset>
                                    ...
                                    <div className="form-group row">
                                        <div className="col-sm-4 col-sm-offset-2">
                                            <Button variant="contained" color="primary" type="submit" className="btn btn-raised btn-primary">Preview SMS</Button>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <Modal isOpen={this.state.modal} toggle={this.toggleModal} size={'lg'}>
                                    ...
                                    <ModalFooter>
                                        <div className="text-center">
                                            <Button variant="contained" color="primary" className="btn btn-raised btn-primary" onClick={this.submitSMS}>Send SMS</Button>
                                        </div>
                                    </ModalFooter>
                                </Modal>
