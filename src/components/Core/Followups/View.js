                                        ...
                                        <table className="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{this.state.obj.contact}</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <strong>Followup Date</strong>
                                                    </td>
                                                    <td><Moment format="DD MMM YY">{this.state.obj.followUpDate}</Moment></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <strong>Type</strong>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><Moment format="DD MMM YY">{this.state.obj.nextFollowUpDate}</Moment></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <strong>Next Followup Type</strong>
                                                    </td>
                                                    <td>{this.state.obj.nextFollowupType}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                                ...
                                                {this.state.subObjs.map((obj, i) => {
                                                    return (
                                                        <tr key={obj.id}>
                                                            ...
                                                            <td>
                                                            {!this.props.readOnly && <Button variant="contained" color="warning" size="xs" onClick={() => this.editSubObj(i)}>Edit</Button>}
                                                            </td>
                                                        </tr>
                                                    )
                                                })}
                    ...
                    <div className="card b">
                        <div className="card-body bb bt">
                            <Add baseUrl={this.props.baseUrl} onRef={ref => (this.addTemplateRef = ref)}
                                reference="0" repository={this.state.baseUrl}
