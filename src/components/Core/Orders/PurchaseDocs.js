    ...
    componentDidMount() {
        // console.log('inventory component did mount');
          ...
          this.props.parentObj.products.forEach(g=>{
              var files=[{label: g.product.name+ ' COA', expiryDate: false }, {label: g.product.name+ ' Sales COA', expiryDate: false }]
              bankingFileTypes[g.product.id]=files;
          });
                 ...
                 {this.props.parentObj.products.map((product, i) => {
                    ...
                    <div className="row">
                        ...
                        <div> {product.product.name} </div>
                                ...
                                <Upload onRef={ref => (this.bankinguploadRef = ref)} fileFrom={this.props.baseUrl + '_Purchase_'+product.product.id} 
                                currentId={this.props.currentId} fileTypes={this.state.bankingFileTypes[product.product.id]?this.state.bankingFileTypes[product.product.id]:[]}></Upload>
